...
from core.auth import damage_login

class DamageLoginGUI:
    def __init__(self):
        self.window = tk.Tk()
        self.window.title("Damage Tracking System - Login")
        ...
        tk.Label(card_frame, text="Damage Tracking System v1.0", font=("Segoe UI", 8), 
    ...
    def login(self):
        ...
        result = damage_login(email, password)
        ...
        from damage_app.main import open_damage_main_menu
        self.window.destroy()
        open_damage_main_menu(result)

    def open_main_menu(self, user_data):
        self.window.destroy()

        main_window = tk.Tk()
        main_window.title("Damage Tracking Main Menu")
        ...
        tk.Label(
            main_window,
            text="(Damage Tracking Dashboard placeholder)",
            font=("Arial", 11),
            fg="gray"
        ).pack()
