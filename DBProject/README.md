# DBProject - Automotive Service and Damage Tracking Database System

DBProject is a desktop database application built for a university database course. It models the operational flow of an automotive service business with two connected modules:
...
4. Make sure the SQL Server database is named `DBProject` or update `DB_NAME`.

5. Run one of the modules.
...
This repository demonstrates database design usage through a real business scenario: entities are connected across customers, vehicles, service operations, inventory, payments, personnel, accidents, assessments, and insurance records. The UI is simple by design, while the database interactions show the main value of the project.
